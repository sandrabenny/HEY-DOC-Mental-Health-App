...
import 'doctor_notifications_page_model.dart';
export 'doctor_notifications_page_model.dart';

class DoctorNotificationsPageWidget extends StatefulWidget {
  const DoctorNotificationsPageWidget({super.key});

  @override
  State<DoctorNotificationsPageWidget> createState() =>
      _DoctorNotificationsPageWidgetState();
}

class _DoctorNotificationsPageWidgetState
    extends State<DoctorNotificationsPageWidget> {
  late DoctorNotificationsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DoctorNotificationsPageModel());
  }
        ...
        body: Stack(
          children: [
            ...
            Align(
              ...
              child: wrapWithModel(
                model: _model.doctorNavBarNotificationsModel,
                updateCallback: () => setState(() {}),
                child: const DoctorNavBarNotificationsWidget(),
              ),
            ),
          ],
        ),
