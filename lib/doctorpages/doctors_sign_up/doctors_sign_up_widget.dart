...
import 'doctors_sign_up_model.dart';
export 'doctors_sign_up_model.dart';

class DoctorsSignUpWidget extends StatefulWidget {
  const DoctorsSignUpWidget({super.key});

  @override
  State<DoctorsSignUpWidget> createState() => _DoctorsSignUpWidgetState();
}

class _DoctorsSignUpWidgetState extends State<DoctorsSignUpWidget> {
  late DoctorsSignUpModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DoctorsSignUpModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<AllUsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AllUsersRecord> doctorsSignUpAllUsersRecordList = snapshot.data!;
        final doctorsSignUpAllUsersRecord =
            doctorsSignUpAllUsersRecordList.isNotEmpty
                ? doctorsSignUpAllUsersRecordList.first
                : null;
                                                ...
                                                onPressed: () async {
                                                  if (_model.emailAddressTextController
                                                    ...
                                                    if ((_model.emailAddressTextController.text != '') &&
                                                      ...
                                                      await doctorsSignUpAllUsersRecord!
                                                          .reference
                                                          .update({
                                                        ...mapToFirestore(
                                                          {
                                                        ...
                                                        builder:
                                                          ...
                                                          return AlertDialog(
                                                            title: const Text(
                                                                'Invalid Details!'),
                                                            content: const Text(
                                                                'Give all informations correctly.'),
                                                            actions: [
                                                              TextButton(
                                                                onPressed: () =>
                                                                    Navigator.pop(
                                                    ...
                                                    await showDialog(
                                                      ...
                                                      builder:
                                                        ...
                                                        return AlertDialog(
                                                          ...
                                                          content: const Text(
                                                              'Please upload your certificate of proof.'),
                                                          actions: [
                                                            TextButton(
                                                              onPressed: () =>
                                                                  Navigator.pop(
