...
import 'doctor_certificate_model.dart';
export 'doctor_certificate_model.dart';
...
class _DoctorCertificateWidgetState extends State<DoctorCertificateWidget> {
  late DoctorCertificateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DoctorCertificateModel());
  }
