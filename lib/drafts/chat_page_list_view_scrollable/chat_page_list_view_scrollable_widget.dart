...
import 'chat_page_list_view_scrollable_model.dart';
export 'chat_page_list_view_scrollable_model.dart';

class ChatPageListViewScrollableWidget extends StatefulWidget {
  const ChatPageListViewScrollableWidget({
    super.key,
  ...
  @override
  State<ChatPageListViewScrollableWidget> createState() =>
      _ChatPageListViewScrollableWidgetState();
}

class _ChatPageListViewScrollableWidgetState
    extends State<ChatPageListViewScrollableWidget> {
  late ChatPageListViewScrollableModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChatPageListViewScrollableModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<MessagingRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<MessagingRecord> chatPageListViewScrollableMessagingRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final chatPageListViewScrollableMessagingRecord =
            chatPageListViewScrollableMessagingRecordList.isNotEmpty
                ? chatPageListViewScrollableMessagingRecordList.first
                : null;
                                ...
                                children: [
                                  ...
                                  StreamBuilder<List<MessagingDepthRecord>>(
                                    stream: queryMessagingDepthRecord(
                                      queryBuilder: (messagingDepthRecord) =>
                                        ...
                                        itemBuilder: (context, listViewIndex) {
                                          ...
                                          return Padding(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                if (((listViewMessagingDepthRecord
                                                                .deliveredMail ==
                                                            widget
                                                                .pStudMail) &&
                                                                      ...
                                                                      style: FlutterFlowTheme.of(
                                                                          ...
                                                                          .override(
                                                                            ...
                                                                            color:
                                                                              ...
                                                                              (listViewMessagingDepthRecord.deliveredMail == widget.pStudMail) && (listViewMessagingDepthRecord.receivedMail == currentUserEmail) ? FlutterFlowTheme.of(context).primaryBtnText : const Color(0xD4010000),
                                                                    ...
                                                                    Align(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          dateTimeFormat(
                                                                              "M/d H:mm",
                                                                              listViewMessagingDepthRecord.deliveredTime!),
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
                                                                              .override(
                                                                                fontFamily: 'Outfit',
                          ...
                          children: [
                            ...
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                ...
                                await chatPageListViewScrollableMessagingRecord!
                                    .reference
                                    .update({
