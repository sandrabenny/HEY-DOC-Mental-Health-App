...
import 'edit_psychology_model.dart';
export 'edit_psychology_model.dart';

class EditPsychologyWidget extends StatefulWidget {
  const EditPsychologyWidget({super.key});

  @override
  State<EditPsychologyWidget> createState() => _EditPsychologyWidgetState();
}

class _EditPsychologyWidgetState extends State<EditPsychologyWidget> {
  late EditPsychologyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditPsychologyModel());
    ...
    return StreamBuilder<List<PsychProfileDetailsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PsychProfileDetailsRecord>
            editPsychologyPsychProfileDetailsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final editPsychologyPsychProfileDetailsRecord =
            editPsychologyPsychProfileDetailsRecordList.isNotEmpty
                ? editPsychologyPsychProfileDetailsRecordList.first
                : null;
                                ...
                                child: Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      await editPsychologyPsychProfileDetailsRecord!
                                          .reference
                                          .update(
                                              createPsychProfileDetailsRecordData(
                                        studProfile: _model.uploadedFileUrl,
                                      ));
                                    },
                                    text: 'Change Profile',
                                  ...
                                  child: SizedBox(
                                    ...
                                    child: TextFormField(
                                      controller: _model.nameTextController ??=
                                        ...
                                        text:
                                            editPsychologyPsychProfileDetailsRecord
                                                ?.studName,
                                      ),
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      await editPsychologyPsychProfileDetailsRecord
                                        ...
                                        studPhone: int.tryParse(
                                            _model.phoneTextController.text),
                                        studDob:
                                            editPsychologyPsychProfileDetailsRecord
                                                .studDob,
                                        studGender: _model.genderValue,
                                        studNationality:
                                            _model.nationalityValue,
                                        studCourse: _model.courseValue,
                                        studUniversity: _model
                                            .universityTextController.text,
                                        studBio: _model.bioTextController.text,
                                        password:
                                            editPsychologyPsychProfileDetailsRecord
                                                .password,
                                        cpassword:
                                        ...
                                        studLanguage: _model.languageValue,
                                      ));
                                      unawaited(
                                        () async {
