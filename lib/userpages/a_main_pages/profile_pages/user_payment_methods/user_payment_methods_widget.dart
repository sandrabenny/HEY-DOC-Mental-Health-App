...
import 'user_payment_methods_model.dart';
export 'user_payment_methods_model.dart';
...
class _UserPaymentMethodsWidgetState extends State<UserPaymentMethodsWidget> {
  late UserPaymentMethodsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserPaymentMethodsModel());
  }
