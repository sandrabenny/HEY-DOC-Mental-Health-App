  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<AllUsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AllUsersRecord> userSignUpAllUsersRecordList = snapshot.data!;
        final userSignUpAllUsersRecord = userSignUpAllUsersRecordList.isNotEmpty
            ? userSignUpAllUsersRecordList.first
            : null;
                                              ...
                                              child: FFButtonWidget(
                                                onPressed: () async {
                                                  if ((_model.fnameTextController
                                                    ...
                                                    await SignupDetailsRecord
                                                        .collection
                                                        .doc()
                                                        .set(
                                                            createSignupDetailsRecordData(
                                                          email: _model
                                                              .emailAddressTextController
                                                              .text,
                                                          password: _model
                                                    ...
                                                    await userSignUpAllUsersRecord!
                                                        .reference
                                                        .update({
                                                      ...mapToFirestore(
                                                        {
                                                      ...
                                                      builder:
                                                        ...
                                                        return AlertDialog(
                                                          title: const Text(
                                                              'Invalid Field!'),
                                                          content: const Text(
                                                              'Please give all informations correctly.'),
                                                          actions: [
                                                            TextButton(
                                                              onPressed: () =>
                                                                  Navigator.pop(
